	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/generate/_server.js'))
			},
			{
				id: "/api/ping",
				pattern: /^\/api\/ping\/?$/,
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/ping/_server.js'))
			},
			{
				id: "/gallery",
				pattern: /^\/gallery\/?$/,
