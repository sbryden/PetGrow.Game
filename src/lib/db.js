// ============================================================
//  PetGrow — IndexedDB Storage (ES Module)
// ============================================================
...
export async function saveActiveGame(gameState) {
  const db = await open();
  return new Promise((resolve, reject) => {
...
export async function migrateFromLocalStorage() {
  try {
    ...
    for (const creature of gallery) await saveCreature(creature);
...
export async function migrateActiveGameFromLocalStorage(saveKey) {
  try {
