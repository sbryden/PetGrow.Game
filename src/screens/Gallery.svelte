<script>
  ...
  $: activeCreature = $gameStore.createdAt && $gameStore.petName ? $gameStore : null;
  ...
  <div class="gallery-body">
    ...
    {#if activeCreature}
      ...
      <section class="active-section">
        ...
        {/if}
        <button class="btn-continue" onclick={() => goTo('pet-game')}>▶ Continue Current Creature</button>
      </section>
    {/if}
